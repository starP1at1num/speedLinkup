...
import com.example.speedlinkup.board.GameService;
import com.example.speedlinkup.board.impl.GameServiceImpl;
import com.example.speedlinkup.utils.GameConf;
import com.example.speedlinkup.utils.LinkInfo;
import com.example.speedlinkup.utils.SizeUtils;
import com.example.speedlinkup.view.GameView;
...
public class MainActivity extends Activity implements BaseHandlerCallBack {
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        int tempWidth = (gameViewWidth - GameConf.BEGIN_IMAGE_X) / (GameConf.PIECE_X_SUM + 1);
        // 每个 方块的 高度 等于 公共画盘的高度 / y方向的个数
        int tempHeight = (gameViewHeight - GameConf.BEGIN_IMAGE_Y) / (GameConf.PIECE_Y_SUM + 1);
    ...
    private void initConfig(){
        ...
        int during = Integer.parseInt(sp.getString("play_during", "100"));
        ...
        config = new GameConf(type, configSize, xSum, ySum, beginImageX, beginImageY, during, this);
