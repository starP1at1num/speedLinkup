package com.example.speedlinkup.view;
...
public class GameView extends View {
    ...
    public void resetSelectedImage() {
        int width = GameConf.PIECE_WIDTH;
        int height = GameConf.PIECE_HEIGHT;
        float scaleWidth =  (float)width / (float)selectImage.getWidth();
        float scaleHeight = (float)height / (float)selectImage.getHeight();
        Matrix matrix = new Matrix();
        matrix.setScale(scaleWidth, scaleHeight);
        selectImage =  Bitmap.createBitmap(selectImage, 0, 0, selectImage.getWidth(), selectImage.getHeight(), matrix, true);
    }
